...
impl __sdk::InModule for TransferDestination {
    type Module = super::RemoteModule;
}

/// Column accessor struct for the table `TransferDestination`.
///
/// Provides typed access to columns for query building.
pub struct TransferDestinationCols {
    pub destination_key: __sdk::__query_builder::Col<TransferDestination, String>,
...
impl __sdk::__query_builder::HasCols for TransferDestination {
    type Cols = TransferDestinationCols;
...
/// Indexed column accessor struct for the table `TransferDestination`.
///
/// Provides typed access to indexed columns for query building.
pub struct TransferDestinationIxCols {
    pub destination_key: __sdk::__query_builder::IxCol<TransferDestination, String>,
...
impl __sdk::__query_builder::HasIxCols for TransferDestination {
    type IxCols = TransferDestinationIxCols;
...
impl __sdk::__query_builder::CanBeLookupTable for TransferDestination {}
